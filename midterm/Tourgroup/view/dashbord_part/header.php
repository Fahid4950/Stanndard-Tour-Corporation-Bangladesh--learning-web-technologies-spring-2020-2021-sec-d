                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/midterm/TourGroup/view/addroomsallupdate.php">Add Rooms</a></li>
                                    <li><a href="/midterm/TourGroup/view/allrooms.php">View Rooms</a></li>
                                    <li><a href="/midterm/TourGroup/view/roomstrash.php">Trash</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/midterm/TourGroup/view/addfoodsallupdate.php">Add Food item</a></li>
                                    <li><a href="/midterm/TourGroup/view/allfoods.php">View Food item</a></li>
                                    <li><a href="/midterm/TourGroup/view/foodstrash.php">Trash</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/midterm/TourGroup/view/payment.php">Payment Receive</a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/midterm/TourGroup/view/event.html">Events</a></li>
                                    <li><a href="/midterm/TourGroup/view/room.html">Book Hotel</a></li>
                                    <li><a href="/midterm/TourGroup/view/food.html">Food Menu</a></li>

                                    <li><a href="/midterm/TourGroup/view/Transport.php">Book Transport</a></li>
                                </ul>
                            </li>
