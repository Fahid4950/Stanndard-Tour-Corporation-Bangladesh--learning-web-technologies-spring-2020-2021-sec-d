...
<h3>Trash  <a class="float-right btn btn-danger" href="allusers.php"> Back</a> </h1></h3>
</div>
...
<td>
            <a href="/../midterm/TourGroup/controller/delete-user.php?id=<?php echo $users['id'] ?>" class="btn btn-danger">Delete</a>
      </td>
      </tr>
