...
require '../db.php';
    ...
    if(empty($eventname))
    {
      ...
      header('location:/../midterm/TourGroup/view/addevents.php?err='.$err);
    ...
    else if (empty($duration))
     {
       ...
       header('location:/../midterm/TourGroup/view/addevents.php?u_err='.$u_err);
    }
    else if (empty($tourarea))
     {
       $e_err ="Where is tour area?";
       header('location:/../midterm/TourGroup/view/addevents.php?e_err='.$e_err);
    }

    else if (empty($package))
     {
       $el_err ="What is in package?";
       header('location:/../midterm/TourGroup/view/addevents.php?el_err='.$el_err);
    }

    else if (empty($price))
     {
       $ell_err ="Price Please!!!";
       header('location:/../midterm/TourGroup/view/addevents.php?ell_err='.$ell_err);
    }
      ...
      $success = 'Registration Successfull!!!';
       ...
       header('location:/../midterm/TourGroup/view/addevents.php?success='.$success);
