...
<script type="text/javascript" src="scriptd.js"></script>
...
<h3> All Events Information    <a class="float-right btn btn-danger" href="/../midterm/view/home.html"> Logout</a> </h3>
</div>
  ...
  <table class="table">
    ...
    <?php foreach ($select_result as  $events) { ?>
      <tr>
        ...
        <td>
            <a href="/../midterm/TourGroup/controller/edit-events.php?id=<?php echo $events['id'] ?>" class="btn btn-success">Update</a>
        </td>
        <td>
