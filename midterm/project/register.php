...
body {
  ...
  background-size: 100% 100%;
    ...
    <h5 class="card-header bg-info text-white"><b>Registration Form</b></h5>
    <div class="card-body">
      ...
      <form class="" action="register-post.php" method="post" auto_complete="off">
        ...
        <div class="form-group">
          ...
          <input type="text"name="fname"class="form-control" placeholder="write your name" >
          <?php
          ...
          <div class="form-group">
            ...
            <input type="text" name="fusername"class="form-control" placeholder="write your username" >
      ...
      <div class="form-group">
        ...
        <input type="text"name="email" class="form-control" placeholder="write your email address"  >
