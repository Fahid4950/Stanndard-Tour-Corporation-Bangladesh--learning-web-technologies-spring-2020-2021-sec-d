...
body {
  ...
  background-size: 100% 100%;
    ...
    <h5 class="card-header bg-primary text-white"><b>Customer Login Form</b></h5>
    <div class="card-body">
      ...
      <a href="registerallupdate.php">Sign Up</a>
...
function validationlogin()
{
  ...
  if(fusername == ""){
    document.getElementById('usernameok').innerHTML = " Error,You doesn't fill the username**";
    return false;
  }
  if(password == ""){
    document.getElementById('passwordok').innerHTML =" Error,You doesn't fill the password** ";
    return false;
  }
}
