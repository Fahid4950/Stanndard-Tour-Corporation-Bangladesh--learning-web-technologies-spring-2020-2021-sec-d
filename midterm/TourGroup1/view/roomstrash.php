...
<h3> Room Trash <a class="float-right btn btn-danger" href="allrooms.php"> Back</a></h3>
</div>
      ...
      <tr>
        ...
        <td>
          ...
          <td>
            ...
            <a href="/../midterm/TourGroup/controller/delete-rooms.php?id=<?php echo $rooms['id'] ?>" class="btn btn-danger">Delete</a>
      </td>
