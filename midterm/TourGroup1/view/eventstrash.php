...
<h3> Events Trash <a class="float-right btn btn-danger" href="allevents.php"> Back</a></h3>
</div>
...
<td>
            <a href="/../midterm/TourGroup/controller/delete-events.php?id=<?php echo $events['id'] ?>" class="btn btn-danger">Delete</a>
      </td>
      </tr>
