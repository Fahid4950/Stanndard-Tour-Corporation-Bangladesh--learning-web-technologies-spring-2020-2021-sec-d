...
<h3> All Rooms Information   <a class="float-right btn btn-danger" href="/../midterm/view/home.html"> Logout</a> </h3>
</div>
  ...
  <table class="table">
    ...
    <?php foreach ($select_result as  $rooms) { ?>
      <tr>
        ...
        <td>
            <a href="/../midterm/TourGroup/controller/edit-rooms.php?id=<?php echo $rooms['id'] ?>" class="btn btn-success">Update</a>
        </td>
        <td>
